    ...
    <>
      <section className="relative min-h-[80svh] flex items-end overflow-hidden">
        ...
        <div className="container-editorial relative z-10 pb-20 pt-40 text-ivory">
          ...
          <Reveal delay={120}>
            <h1 className="mt-6 font-display text-5xl md:text-7xl lg:text-[5.5rem] max-w-4xl leading-[1.02] text-ivory">
      ...
      <section className="py-32">
        <div className="container-editorial grid gap-16 lg:grid-cols-12">
          <div className="lg:col-span-4">
            ...
            <Reveal delay={100}>
              <h2 className="mt-5 font-display text-4xl text-ink leading-tight">Our Story</h2>
            </Reveal>
          </div>
          <div className="lg:col-span-8 space-y-6 text-lg text-slate-body leading-relaxed">
            <Reveal>
              <p>
      ...
      {/* Mission / Vision */}
      <section className="bg-cream border-y border-border py-28">
        <div className="container-editorial grid gap-16 md:grid-cols-2">
          <Reveal>
            <div>
              <div className="eyebrow">Mission</div>
              <h3 className="mt-5 font-display text-4xl text-ink leading-tight">
      ...
      <section className="bg-ink text-ivory py-24">
        <div className="container-editorial flex flex-col md:flex-row md:items-center justify-between gap-8">
          <h2 className="font-display text-3xl md:text-5xl text-ivory max-w-2xl leading-tight">
            Want to bring Bridges to your school?
          </h2>
          <Link to="/contact" className="btn-ghost self-start md:self-auto">Partner With Us</Link>
        </div>
      </section>
    </>
  );
