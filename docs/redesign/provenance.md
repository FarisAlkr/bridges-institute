...
| Page                                                                 | Origin                                                                                                                                                                                                                                            |
| -------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Accessibility Statement** (`src/pages/AccessibilityStatement.tsx`) | **[AUTHORED]** prose, but it _describes real work actually done_ (landmarks, focus, contrast). Coordinator name/phone + HE/AR are **[PLACEHOLDER]**.                                                                                              |
